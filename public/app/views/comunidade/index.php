        ...
        <?php else: ?>
            ...
            ?>
                <div class="glass-panel" style="background: white; padding: 0; margin-bottom: 2rem; overflow: hidden;">
                    ...
                    <div style="border-top: 1px solid var(--color-border); padding: 1rem 1.5rem; display: flex; gap: 2rem; align-items: center;">
                        <a href="?url=comunidade/curtir/<?= $post['id'] ?>" style="text-decoration: none; font-weight: 600; display: flex; align-items: center; gap: 0.5rem; color: <?= $jaCurtiu ? 'var(--color-primary)' : 'var(--color-text-muted)' ?>;">
                            <?= $jaCurtiu ? '❤️' : '🤍' ?> <span><?= $post['total_curtidas'] ?></span>
                        </a>
