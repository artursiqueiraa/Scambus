...
class ControladorServico {
    ...
    public function salvar(){
        ...
        if(!empty($_FILES['foto']['tmp_name'])){
            require_once "../nucleo/Seguranca.php";
            $fotoNome = Seguranca::uploadSeguro($_FILES['foto']['tmp_name'], "../uploads/servicos/", ['image/jpeg', 'image/png', 'image/webp']);
...
if(!empty($_FILES['fotos']['tmp_name'][0])){
    ...
    foreach($_FILES['fotos']['tmp_name'] as $key => $tmp_name){
        ...
        $nomeArquivo = Seguranca::uploadSeguro($tmp_name, "../uploads/servicos/", ['image/jpeg', 'image/png', 'image/webp']);
...
if(!empty($_FILES['foto']['tmp_name'])){
    require_once "../nucleo/Seguranca.php";
    $nomeArq = Seguranca::uploadSeguro($_FILES['foto']['tmp_name'], "../uploads/servicos/", ['image/jpeg', 'image/png', 'image/webp']);
    if($nomeArq) {
        $fotoNome = $nomeArq;
    }
}
